...
def ping(denodo_home_path: str, trust_path: str, hostname: str, timeout: str, vdbname: str, usr: str, passwd: str):
    ...
    denodo_classpath = os.path.join(lib_path_vdp, "vdp-client-core", "denodo-vdp-client.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "denodo-asyncrmi.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "vdp-client-core", "denodo-vdp-tool.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "commons-util.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "commons-codec.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "commons-collections4.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "commons-lang3.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "commons-pool2.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "icu4j.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "log4j-api.jar")
    denodo_classpath += ":" + os.path.join(lib_path_vdp, "contrib", "log4j-core.jar")
    ...
    if os.path.exists(conf_path_vdp) and not os.path.exists(dbtools_path):
        denodo_classpath += ":" + conf_path_vdp
    elif os.path.exists(dbtools_path):
        denodo_classpath += ":" + dbtools_path
    else:
        denodo_classpath += ":" + dbtools_path
